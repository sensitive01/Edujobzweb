      ...
      <React.Suspense fallback={null}>
        <Routes>
          ...
          <Route element={<EmployerLayout />}>
            ...
            />
            <Route
              path="/employer/verify-otp"
              element={<EmployerVerifyOTP />}
            />
            ...
            <Route
              path="/employer/plans-grid"
              element={<EmployeerPlansGrid />}
            />
              ...
              <Layout>
                <Routes>
                  ...
                  <Route
                    ...
                    element={<JobsPageList />}
                  />
                  <Route
                    path="/job-vacancies-map"
                    element={<JobPageMapGrid />}
                  />
