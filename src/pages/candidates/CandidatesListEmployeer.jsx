  ...
  useEffect(() => {
    const fetchCandidates = async () => {
      try {
        ...
        if (filters.jobRole && filters.jobRole !== 'All Roles') queryParams.append('jobRole', filters.jobRole);
        if (filters.location && filters.location !== 'All Locations') queryParams.append('location', filters.location);
        if (filters.experience && filters.experience !== 'All Experiences') queryParams.append('experience', filters.experience);

        console.log('Fetching with filters:', queryParams.toString()); // Debug log

        const response = await fetch(
          `https://edujobzbackend.onrender.com/employer/viewallappliedcandi/${userData._id}?${queryParams.toString()}`,
          {
            headers: {
            ...
            <div className="row">
              <div className="col-12">
                ...
                <header className="page-subheader mb-30 mb-md-40 d-xxl-flex align-items-center justify-content-between">
                  <h3 className="h6 mb-25 mb-xxl-0 text-secondary">{candidates.length} candidates found</h3>
                </header>
  ...
  return (
    <div className="card h-100 shadow-sm">
      <div className="card-body text-center">
        ...
        <p className="text-muted mb-1">{candidate.experience} years experience</p>
