...
const PlansList = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://edujobzbackend.onrender.com/admin/createplan', {
        method: 'POST',
        headers: {
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`https://edujobzbackend.onrender.com/admin/updateplan${currentPlan._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      setPlans(plans.map(plan => plan._id === currentPlan._id ? data.data : plan));
      setFilteredPlans(filteredPlans.map(plan => plan._id === currentPlan._id ? data.data : plan));
  ...
  const handleDelete = async () => {
    try {
     const response = await fetch(`https://edujobzbackend.onrender.com/admin/deleteplan${planToDelete._id}`, {
        method: 'DELETE'
      });
      ...
      setFilteredPlans(filteredPlans.filter(plan => plan._id !== planToDelete._id));
      ...
      <div className="content">
        ...
        <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
          <div className="my-auto">
            <h2>&nbsp; <i className="fa fa-credit-card text-primary"></i> Subscription Plans</h2>
          </div>
                    ...
                    <tr key={plan._id}>
                      ...
                      <td>
                        <div className="action-icon d-inline-flex">
                          <a href="#" className="me-2" onClick={(e) => { e.preventDefault(); handleEdit(plan); }}><i className="ti ti-edit"></i></a>
                          <a href="#" onClick={(e) => { e.preventDefault(); setPlanToDelete(plan); setShowDeleteModal(true); }}><i className="ti ti-trash text-danger"></i></a>
                        </div>
                      </td>
                    </tr>
                  ))}
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-body text-center">
                 ...
                 <p className="mb-3">Are you sure you want to delete the plan "{planToDelete?.name}"? This action cannot be undone.</p>
...
const PlanForm = ({ formData, handleInputChange, handleNumberInputChange }) => {
  return (
    <div className="row">
      ...
      <div className="col-md-6">
        <div className="mb-3">
          <label className="form-label">Per Day Limit<span className="text-danger"> *</span></label>
          <input 
            type="number" 
            className="form-control" 
            name="perDayLimit"
      ...
      <div className="col-md-6">
        <div className="mb-3">
          <label className="form-label">Download Resume Limit<span className="text-danger"> *</span></label>
          <input 
            type="number" 
            className="form-control" 
            name="downloadResume"
            ...
            <div className="col-md-4">
              <div className="form-check form-switch mb-3">
                <input 
                  ...
                  onChange={handleInputChange}
                />
                <label className="form-check-label">Download Resume Manager</label>
              </div>
            </div>
            <div className="col-md-4">
              <div className="form-check form-switch mb-3">
            ...
            <div className="col-md-4">
              <div className="form-check form-switch mb-3">
                <input 
                  ...
                  onChange={handleInputChange}
                />
                <label className="form-check-label">Access to Recruitment Fair</label>
              </div>
            </div>
            <div className="col-md-4">
              <div className="form-check form-switch mb-3">
