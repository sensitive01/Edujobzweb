                ...
                <div className='d-flex align-items-center justify-content-between'>
                    ...
                    <div className='d-flex align-items-center'>
                        <div className='d-flex align-items-center me-4'>
                            <Link to="/admin/dashboard" className='d-flex align-items-center justify-content-center me-3 rounded'
                                style={{
                                    width: '100px',
                                }}
                            >
                    ...
                    <nav className='d-none d-lg-flex align-items-center'>
                        <div className='d-flex align-items-center'>
                            <Link to="/admin/dashboard" className='d-flex align-items-center fw-medium px-3 py-2 rounded me-2 menu text-decoration-none'>
                                <i class="ti ti-layout-grid-remove text-primary"></i>
                                <span className="text-dark">dashboard</span>
                            </Link>
                            <Link to="/admin/candidate-list" className='d-flex align-items-center fw-medium px-3 py-2 rounded me-2 menu text-decoration-none'>
                                <i class="ti ti-layout-grid-remove text-primary"></i>
                    ...
                    <div className='d-flex align-items-center'>
                        ...
                        <div className='d-none d-lg-flex align-items-center'>
                            ...
                            <Link to="/admin/support" className="btn btn-link p-2 text-secondary me-2 position-relative text-decoration-none">
                                <HelpCircle size={16} />
                                <span
                            ...
                            {notificationDropdown && (
                                ...
                                >
                                    ...
                                    <div className="d-flex p-0">
                                        ...
                                        <a href="/admin/notifications" className="btn btn-primary w-100">View All</a>
                                    </div>
                                </div>
                            )}
                        </div>
