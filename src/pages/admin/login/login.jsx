...
//         try {
//             const response = await fetch('https://edujobzbackend.onrender.com/admin/adminlogin', {
//                 method: 'POST',
//                 headers: {
...
//             // On successful login
//             localStorage.setItem('adminToken', 'admin-authenticated'); // You might want to store an actual token from the backend
