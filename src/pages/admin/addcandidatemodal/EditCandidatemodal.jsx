...
const EditCandidateModal = ({ show, candidate, onClose, onUpdate }) => {
    ...
    const fetchCandidateDetails = async () => {
        try {
            setLoading(true);
            const response = await fetch(`https://edujobzbackend.onrender.com/fetchemployee/${candidate._id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                `https://edujobzbackend.onrender.com/updateprofile/${candidate._id}`,
                {
                    method: 'PUT',
                    headers: {
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <div className="d-flex align-items-center">
                            ...
                            <span>Candidate ID : {candidate._id.substring(candidate._id.length - 4)}</span>
                        </div>
                        <button 
                            type="button" 
                                                ...
                                                <div className="col-md-12">
                                                    <div className="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">                                                
                                                        <div className="d-flex align-items-center justify-content-center avatar avatar-xxl rounded-circle border border-dashed me-2 flex-shrink-0 text-dark frames">
                                                            <img 
                                                                src={candidate.userProfilePic || 'assets/img/users/user-13.jpg'} 
                                                                alt="img" 
