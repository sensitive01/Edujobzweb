...
const AddCandidateModal = ({ show, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.userName || !formData.userMobile || !formData.userEmail || !formData.userPassword) {
        ...
        try {
            const response = await axios.post('https://edujobzbackend.onrender.com/signup', formData);
                                ...
                                <div className="tab-content" id="myTabContent">
                                    {activeTab === 'basic-info' && (
                                        <div className="tab-pane fade show active" id="basic-info" role="tabpanel" aria-labelledby="info-tab" tabIndex="0">
                                            ...
                                            <div className="modal-footer">
                                                <button type="button" className="btn btn-outline-light border me-2" onClick={onClose} disabled={loading}>
                                                    Cancel
                                                </button>
