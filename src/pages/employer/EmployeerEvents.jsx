...
//   const organizerId = employerData?._id;
...
//         if (key === 'bannerImage' && newEvent[key]) {
//           formData.append('file', newEvent[key]);
//         } else if (newEvent[key]) {
//           formData.append(key, newEvent[key]);
//         }
//       });

//       const response = await fetch(`https://edujobzbackend.onrender.com/employer/${organizerId}/events`, {
//         method: 'POST',
//         body: formData,
//       });
...
//   const matchesDate = (!fromDate || !eventDate || eventDate >= new Date(fromDate)) &&
//     (!toDate || !eventDate || eventDate <= new Date(toDate));
...
// const onHoldEvents = filteredEvents.filter(event => 
//   event?.status === 'On-hold' || event?.status === 'Cancelled'
// );
...
// with craete event but error for view
