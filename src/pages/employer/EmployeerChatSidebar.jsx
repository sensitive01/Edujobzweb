...
//     try {
//       const token = localStorage.getItem('employerToken');
//       const response = await axios.get(`https://api.edprofio.com/fetchemployee/${employeeId}`, {
//         headers: {
//           'Authorization': `Bearer ${token}`
//         }
//       });
...
//       const response = await axios.post('https://api.edprofio.com/employer/sendchats', formData, {
//         headers: {
//           'Authorization': `Bearer ${token}`,
...
//   //     await axios.post('https://api.edprofio.com/employer/sendchats', formData, {
//   //       headers: {
//   //         'Authorization': `Bearer ${token}`,
//   //         'Content-Type': 'multipart/form-data'
//   //       }
...
//       axios.post('https://api.edprofio.com/employer/sendchats', formData, {
//         headers: {
//           'Authorization': `Bearer ${token}`,
//           'Content-Type': 'multipart/form-data'
//         }
