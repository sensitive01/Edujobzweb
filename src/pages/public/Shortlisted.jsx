  ...
  useEffect(() => {
    const fetchShortlistedJobs = async () => {
      try {
        ...
        const response = await axios.get(`https://edujobzbackend.onrender.com/fetchshorlitstedjobsemployee/${userData._id}`);
        ...
        if (err.response?.data?.message === "No shortlisted jobs found") {
          ...
          setError(err.response?.data?.message || err.message || 'Failed to fetch shortlisted jobs');
        }
      } finally {
        setLoading(false);
      }
            ...
            <div className="jobplugin__settings">
              ...
              <div className="jobplugin__settings-content">
                <div className="jobplugin__settings-head">
                  ...
                  <p className="jobplugin__settings-head__text">Your applications that have progressed beyond the initial stage</p>
                </div>
                ...
                {error ? (
                  ...
                  <>
                    <div className="row justify-content-center">
                      {shortlistedJobs.map((job) => {
                        ...
                        const userApplication = job.applications.find(app => app.applicantId === JSON.parse(localStorage.getItem('userData'))._id);
                              ...
                              <div className="textbox">
                                ...
                                <div className="job-info">
                                  <span className="amount">
                                    ...
                                    </strong> / {job.salaryType || 'month'}
                                  </span>
                                  <span className="subtext">
                                    <b className="text-primary">Status:</b> {userApplication?.employapplicantstatus || 'Unknown'}
                                  </span>
                                </div>
                                <div className="d-flex justify-content-between">
                                  <a href={`/job-details/${job._id}`} className="btn btn-dark-yellow btn-sm">
                                  ...
                                  <div className="badge bg-success">
                                    {userApplication?.employapplicantstatus || 'Unknown status'}
                                  </div>
                                </div>
                              </div>
                            </article>
                  ...
                  <div className="empty-state text-center py-5 px-3">
                    ...
                    <h3 className="text-secondary mb-3">No Shortlisted Jobs Yet</h3>
