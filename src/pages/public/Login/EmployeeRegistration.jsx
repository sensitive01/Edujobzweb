...
//                       <input 
//                         type="text" 
//                         placeholder="Preferred Location/Pincode" 
//                         style={{ padding: '5px 30px' }} 
//                         className="form-control" 
//                       />
//                     </div>
...
//                   <div className="jobplugin__form-row">
//                     <div className="jobplugin__form-field">
//                       <select className="select2" name="gender" data-placeholder="Gender">
...
//                   <div className="jobplugin__form-row">
//                     <div className="jobplugin__form-field">
//                       <select className="select2" name="city" data-placeholder="Preferred City">
//                         <option label="preferred City"></option>
//                         <option value="bengaluru">Bengaluru</option>
//                         <option value="mysuru">Mysuru</option>
//                       </select>
//                     </div>
//                     <div className="jobplugin__form-field">
//                       <select className="select2" name="state" data-placeholder="Availability">
//                         <option label="Availability"></option>
...
//                       <input 
//                         type="text" 
//                         placeholder="Subjects you are qualified to teach" 
//                         style={{ padding: '5px 30px' }} 
//                         className="form-control" 
//                       />
//                     </div>
...
//                   <strong htmlFor="cv">&nbsp; Upload your CV</strong>
//                   <br />
//                   <div className="jobplugin__form-row">
//                     <div className="jobplugin__form-field">
//                       <input 
