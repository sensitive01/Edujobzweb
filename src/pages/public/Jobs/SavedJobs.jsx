...
const SavedJobs = () => {
  ...
  useEffect(() => {
    const fetchSavedJobs = async () => {
      try {
        ...
        const response = await axios.get(`https://edujobzbackend.onrender.com/employer/fetchSavedJobs/${userData._id}`);
  ...
  const handleUnsaveJob = async (jobId) => {
    try {
      ...
      await axios.post('https://edujobzbackend.onrender.com/employer/toggleSaveJob', {
            ...
            <div className="jobplugin__settings">
              ...
              <div className="jobplugin__settings-content">
                <div className="jobplugin__settings-head">
                  ...
                  <p className="jobplugin__settings-head__text">Your bookmarked jobs appear here</p>
                </div>
