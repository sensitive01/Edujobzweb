...
const UnitEditSchoolModal = ({ show, onClose, schoolData }) => {
  const [formData, setFormData] = useState({
    name: schoolData?.name || 'Stellar Dynamics',
    email: schoolData?.email || 'sophie@example.com',
    accountUrl: schoolData?.accountUrl || 'sd.example.com',
    phone: schoolData?.phone || '+1 895455450',
    website: schoolData?.website || 'Admin Website',
    password: schoolData?.password || '123',
    confirmPassword: schoolData?.confirmPassword || '123',
    address: schoolData?.address || '',
    planName: schoolData?.planName || 'Advanced',
    planType: schoolData?.planType || 'Monthly',
    currency: schoolData?.currency || 'USD',
    language: schoolData?.language || 'English',
...
export default UnitEditSchoolModal;