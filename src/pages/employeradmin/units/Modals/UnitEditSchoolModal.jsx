...
const schoolEditSchoolModal = ({ show, onClose, school, onSave }) => {
    ...
    const uploadProfilePicture = async (file) => {
        ...
        try {
            const response = await axios.put(
                `https://edujobzbackend.onrender.com/employer/uploadprofilepic/${school.id}?fileType=profileImage`,
                formData,
                {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://edujobzbackend.onrender.com/employer/updateemployer/${school.id}`,
                {
                    ...formData,
            ...
            setError(error.response?.data?.message || 'Failed to update school. Please try again.');
            toast.error(error.response?.data?.message || 'Failed to update school. Please try again.', {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
                                            ...
                                            <div className="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">
                                                ...
                                                <div className="profile-upload">
                                                    <div className="mb-2">
                                                        ...
                                                        <p className="fs-12">Image should be below 2MB (JPEG, PNG, GIF)</p>
                                                        {uploadError && (
