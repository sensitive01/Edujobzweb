...
const UnitsPage = () => {
        ...
        return [
            {
                label: 'Today',
                value: 'today',
                dateLabel: `${today.getDate().toString().padStart(2, '0')}/${(today.getMonth() + 1).toString().padStart(2, '0')}/${currentYear}`
            },
            {
                label: 'Yesterday',
                value: 'yesterday',
            ...
            },
            {
                ...
                dateLabel: (() => {
                    ...
                    return `${week.getDate().toString().padStart(2, '0')}/${(week.getMonth() + 1).toString().padStart(2, '0')}/${week.getFullYear()} - ${today.getDate().toString().padStart(2, '0')}/${(today.getMonth() + 1).toString().padStart(2, '0')}/${currentYear}`;
                })()
            },
            {
                label: 'This Year',
  ...
  setShowDateDropdown(false);
    ...
    useEffect(() => {
        applyFilters();
    }, [selectedDateRange, selectedPlan, selectedStatus, sortBy, schools, dateRange]);
