...
const AddPositionsModal = ({ show, onClose, onAddAccess, employerId }) => {
    ...
    const handleChange = (e) => {
        ...
        if (type === 'checkbox') {
            if (name === 'isRemote') {
                ...
                // For skills or other arrays, you might need different handling
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://edujobzbackend.onrender.com/employer/postjob', formData);
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="modal-body pb-0">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label">Number of Openings <span className="text-danger">*</span></label>
                                        <input
                                            type="number"
                                            className="form-control"
                                            name="openings"
                                ...
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label">Salary Range (From) <span className="text-danger">*</span></label>
                                        <input
                                            type="number"
                                            className="form-control"
                                            name="salaryFrom"
                                ...
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label">Salary Range (To) <span className="text-danger">*</span></label>
                                        <input
                                            type="number"
                                            className="form-control"
                                            name="salaryTo"
                                ...
                                <div className="col-md-12">
                                    <div className="mb-3">
                                        <label className="form-label">Required Skills (comma separated) <span className="text-danger">*</span></label>
                                        <input
                                            type="text"
                                            className="form-control"
                                            name="skills"
                                ...
                                <div className="col-md-12">
                                    <div className="mb-3">
                                        <label className="form-label">Application Instructions <span className="text-danger">*</span></label>
                                        <textarea
                                            className="form-control"
                                ...
                                <div className="col-md-6">
                                    <div className="mb-3">
                                        <label className="form-label">Application Deadline <span className="text-danger">*</span></label>
                                        <input
                                            type="date"
                                            className="form-control"
                                            name="deadline"
