      ...
      <div className="job-wrapper">
        <div className="breadcrumb position-relative bg-secondary py-5">
          ...
          <div className="breadcrumb-bg">
            <span><img src={jobBg01} className="job-bg-01" alt="Background" /></span>
            <span><img src={jobBg02} className="job-bg-02" alt="Background" /></span>
            <span><img src={jobBg03} className="job-bg-03" alt="Background" /></span>
                ...
                <div className="row align-items-center">
                  <div className="col-xl-9 col-md-8">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <h2 className="fw-medium mb-1 text-truncate text-primary">{job.jobTitle}</h2>
                  ...
                  <div className="col-xl-3 col-md-4">
                    <div className="d-flex align-items-center justify-content-end mb-3">
                      ...
                      <span className="badge bg-primary-transparent">{formatDate(job.deadline)}</span>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="col-xl-3 col-md-4 col-sm-6">
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p>{job.location} {job.isRemote && '(Remote)'}</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-xl-3 col-md-4 col-sm-6">
                ...
                <div className="card">
                  <div className="card-body">
                      ...
                      <div className="card-body p-3">
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            {job.companyUrl && (
                              <a href={job.companyUrl} className="text-info" target="_blank" rel="noopener noreferrer">
                                {job.companyUrl}
                              </a>
                            )}
                          </div>
                    ...
                    <div>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-2">
                        <span>Phone</span>
                        <p className="text-gray-7">{job.contactPhone || 'Not provided'}</p>
                      </div>
                      <div className="d-flex align-items-center justify-content-between mb-2">
                        <span>Email</span>
                        <a href={`mailto:${job.contactEmail}`} className="text-info">
              ...
              <>
                ...
                <div className="row">
                  {relatedJobs.map((relatedJob) => (
                    <div key={relatedJob.id} className="col-xxl-3 col-lg-4 col-md-6">
                      <div className="card">
                        <div className="card-body">
                          <div className="card bg-light">
                            <div className="card-body p-3">
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  <h6 className="fw-medium mb-1 text-truncate">
                                    <Link to={`/employer/post-jobs/${relatedJob.id}`}>{relatedJob.title}</Link>
                                  </h6>
                                  <p className="fs-12 text-gray fw-normal">{relatedJob.applicants} Applicants</p>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-flex flex-column mb-3">
                            <p className="text-dark d-inline-flex align-items-center mb-2">
                              <i className="ti ti-map-pin-check text-primary me-2"></i>
                              {relatedJob.location} {relatedJob.isRemote && '(Remote)'}
                            </p>
                            <p className="text-dark d-inline-flex align-items-center mb-2">
                              <i className="ti ti-currency-rupee text-primary me-2"></i>
                              {relatedJob.salary}
                ...
                <form action="">
                  <div className="modal-body">
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" placeholder="Enter the candidate name" />
                    </div>
                    <div className="mb-3">
                      <label className="form-label">Contact Number</label>
                      <input type="text" className="form-control" placeholder="enter the candidate contact number" />
                    </div>
                    <div className="mb-3">
                      <label className="form-label">Email Address</label>
                      <input type="email" className="form-control" placeholder="Enter the candidate email id" />
                    </div>
                    <div className="mb-3">
                      <label className="form-label">Other Notes</label>
                      <textarea className="form-control" rows="3" placeholder="Enter other details..."></textarea>
                    </div>
                    <div>
